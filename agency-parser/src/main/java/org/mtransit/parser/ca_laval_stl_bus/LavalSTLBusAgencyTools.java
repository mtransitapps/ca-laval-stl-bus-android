...
public class LavalSTLBusAgencyTools extends DefaultAgencyTools {
	...
	public @Nullable String getServiceIdCleanupRegex() {
		return "^[A-Z]+\\d{2}"; // service ID is like MMMMyy (ex: "JANV26")
	}
	...
	private static final Pattern STARTS_WITH_DIRECTION_HEADSIGN_VALUE_ = Pattern.compile("^(E|O|W|N|S", Pattern.CASE_INSENSITIVE);
